...
const personaje_models_1 = require("../models/personaje.models");
const personajeRoutes = (0, express_1.Router)();
personajeRoutes.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const personajes = yield personaje_models_1.Personaje.find();
    return res.json({
        ok: true,
        personajes
    });
...
personajeRoutes.get('/paging', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let skip = page - 1;
    skip = skip * perPage;
    const personajes = yield personaje_models_1.Personaje.find().skip(skip).limit(perPage);
    return res.json({
        ok: true,
        personajes
    });
...
personajeRoutes.post('/', (req, res) => {
    ...
    personaje_models_1.Personaje.create(personaje).then(personajeDb => {
        return res.json({
            ok: true,
            personajeDb
        });
...
personajeRoutes.put('/:id', (req, res) => {
    ...
    personaje_models_1.Personaje.findByIdAndUpdate(personajeId, personaje).then(personajeDb => {
        return res.json({
            ok: true,
            personajeDb
        });
...
personajeRoutes.delete('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    personaje_models_1.Personaje.findByIdAndDelete(personajeId).then(personaje => {
        return res.json({
            ok: true,
